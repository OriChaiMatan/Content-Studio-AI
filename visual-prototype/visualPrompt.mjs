// Phase 1 (prototype) — cinematic background prompt builder.
// Wraps the extracted visual intent in a Hollywood-realism template.
// Colors are UNRESTRICTED (no brand-color matching). No generated text/logos/UI.
// Composition is FREE but overlay-safe: a light rule keeps the frame usable for a
// text overlay WITHOUT forcing boring empty negative space. The renderer's scrim
// handles final readability.

export function buildBackgroundPrompt(visualIntent) {
