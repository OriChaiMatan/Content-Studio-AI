...
export function UseCases({ vals }: { vals: LandingVals }) {
  return (
    <section style={{ padding: '100px 40px', textAlign: 'center' }}>
      <h2 data-reveal="1" style={{ ...reveal, fontSize: 44, fontWeight: 700, margin: '0 0 48px' }}>Built for people who think in public.</h2>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 16, maxWidth: 1200, margin: '0 auto', textAlign: 'left' }}>
