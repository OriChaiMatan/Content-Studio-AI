      ...
      <div style={{ display: 'flex', gap: 24, maxWidth: 720, margin: '0 auto', alignItems: 'flex-start', justifyContent: 'center', flexWrap: 'wrap' }}>
        ...
        >
          ...
          <button
            ...
            style={{ display: 'block', width: '100%', textAlign: 'center', marginTop: 20, background: '#1E54C8', border: 'none', borderRadius: 10, padding: 10, fontSize: 14, fontWeight: 700, color: 'white', textDecoration: 'none', cursor: 'pointer', fontFamily: 'inherit' }}
          >
            Join the Waitlist
          </button>
